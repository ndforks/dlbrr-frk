...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'categorylist'; // To manage different context of search
...
$removeelem = request()->integer('removeelem', 0);
$elemid     = request()->integer('elemid', 0);

if (request()->input('addintocategory')) {
