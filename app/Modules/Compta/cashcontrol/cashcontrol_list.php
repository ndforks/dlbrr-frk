...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'cashcontrol'; // To manage different context of search
...
$mode       = request()->input('mode');  // for mode view result
...
if (empty($page) || $page < 0 || request()->input('button_search') || request()->input('button_removefilter') || (empty($toselect) && $massaction === '0')) {
