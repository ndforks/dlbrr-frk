...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'directdebitcredittransferlinelist'; // To manage different context of search
...
$search_line = request()->input('search_line');
$search_bon = request()->input('search_bon');
$search_code = request()->input('search_code');
$search_company = request()->input('search_company');
$statut = request()->integer('statut', 0);
