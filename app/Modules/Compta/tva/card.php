...
if ($action == 'create') {
	...
	print '<tr><td class="titlefieldcreate fieldrequired">'.$langs->trans("Label").'</td><td><input class="minwidth300" name="label" id="label" value="'.(request()->has('label') ? request()->input('label') : $label).'" autofocus></td></tr>';
