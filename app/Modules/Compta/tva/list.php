...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'salestaxeslist';
...
$search_dateend_start = dol_mktime(0, 0, 0, request()->integer('search_dateend_startmonth', 0), request()->integer('search_dateend_startday', 0), request()->integer('search_dateend_startyear', 0));
$search_dateend_end = dol_mktime(23, 59, 59, request()->integer('search_dateend_endmonth', 0), request()->integer('search_dateend_endday', 0), request()->integer('search_dateend_endyear', 0));
$search_datepayment_start = dol_mktime(0, 0, 0, request()->integer('search_datepayment_startmonth', 0), request()->integer('search_datepayment_startday', 0), request()->integer('search_datepayment_startyear', 0));
$search_datepayment_end = dol_mktime(23, 59, 59, request()->integer('search_datepayment_endmonth', 0), request()->integer('search_datepayment_endday', 0), request()->integer('search_datepayment_endyear', 0));
...
if (!empty($search_dateend_start)) {
	$param .= '&search_dateend_startyear='.request()->integer('search_dateend_startyear', 0);
}
if (!empty($search_dateend_start)) {
	$param .= '&search_dateend_startmonth='.request()->integer('search_dateend_startmonth', 0);
}
if (!empty($search_dateend_start)) {
	$param .= '&search_dateend_startday='.request()->integer('search_dateend_startday', 0);
}
if (!empty($search_dateend_end)) {
	$param .= '&search_dateend_endyear='.request()->integer('search_dateend_endyear', 0);
}
if (!empty($search_dateend_end)) {
	$param .= '&search_dateend_endmonth='.request()->integer('search_dateend_endmonth', 0);
}
if (!empty($search_dateend_end)) {
	$param .= '&search_dateend_endday='.request()->integer('search_dateend_endday', 0);
}
if (!empty($search_datepayment_start)) {
	$param .= '&search_datepayment_startyear='.request()->integer('search_datepayment_startyear', 0);
}
if (!empty($search_datepayment_start)) {
	$param .= '&search_datepayment_startmonth='.request()->integer('search_datepayment_startmonth', 0);
}
if (!empty($search_datepayment_start)) {
	$param .= '&search_datepayment_startday='.request()->integer('search_datepayment_startday', 0);
}
if (!empty($search_datepayment_end)) {
	$param .= '&search_datepayment_endyear='.request()->integer('search_datepayment_endyear', 0);
}
if (!empty($search_datepayment_end)) {
	$param .= '&search_datepayment_endmonth='.request()->integer('search_datepayment_endmonth', 0);
}
if (!empty($search_datepayment_end)) {
	$param .= '&search_datepayment_endday='.request()->integer('search_datepayment_endday', 0);
}
if (!empty($search_type) && $search_type > 0) {
