...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'knowledgerecordlist'; // To manage different context of search
...
$searchCategoryKnowledgemanagementList = request()->input('search_category_knowledgemanagement_list');
$searchCategoryKnowledgemanagementOperator = 0;
if (request()->has('formfilteraction')) {
	$searchCategoryKnowledgemanagementOperator = request()->integer('search_category_knowledgemanagement_operator', 0);
