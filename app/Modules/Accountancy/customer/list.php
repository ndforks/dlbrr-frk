...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'accountancycustomerlist'; // To manage different context of search
...
if (request()->input('sortfield') == 'f.datef, f.ref, l.rowid') {
