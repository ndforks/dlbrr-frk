...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'stocklist'; // To manage different context of search
...
$search_ref = request()->input('sref') ? request()->input('sref') : request()->input('search_ref');
$search_label = request()->input('snom') ? request()->input('snom') : request()->input('search_label');
