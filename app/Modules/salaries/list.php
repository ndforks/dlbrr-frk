...
$search_date_start_from = dol_mktime(0, 0, 0, request()->integer('search_date_start_frommonth', 0), request()->integer('search_date_start_fromday', 0), request()->integer('search_date_start_fromyear', 0));
$search_date_start_to = dol_mktime(23, 59, 59, request()->integer('search_date_start_tomonth', 0), request()->integer('search_date_start_today', 0), request()->integer('search_date_start_toyear', 0));
$search_date_end_from = dol_mktime(0, 0, 0, request()->integer('search_date_end_frommonth', 0), request()->integer('search_date_end_fromday', 0), request()->integer('search_date_end_fromyear', 0));
$search_date_end_to = dol_mktime(23, 59, 59, request()->integer('search_date_end_tomonth', 0), request()->integer('search_date_end_today', 0), request()->integer('search_date_end_toyear', 0));
...
if (!empty($search_date_start_from)) {
	$param .= '&search_date_start_fromday='.urlencode(request()->input('search_date_start_fromday')).'&search_date_start_frommonth='.urlencode(request()->input('search_date_start_frommonth')).'&search_date_start_fromyear='.urlencode(request()->input('search_date_start_fromyear'));
}
if (!empty($search_date_start_to)) {
	$param .= "&search_date_start_today=".urlencode(request()->input('search_date_start_today'))."&search_date_start_tomonth=".urlencode(request()->input('search_date_start_tomonth'))."&search_date_start_toyear=".urlencode(request()->input('search_date_start_toyear'));
}
if (!empty($search_date_end_from)) {
	$param .= '&search_date_end_fromday='.urlencode(request()->input('search_date_end_fromday')).'&search_date_end_frommonth='.urlencode(request()->input('search_date_end_frommonth')).'&search_date_end_fromyear='.urlencode(request()->input('search_date_end_fromyear'));
}
if (!empty($search_date_end_to)) {
	$param .= "&search_date_end_today=".urlencode(request()->input('search_date_end_today'))."&search_date_end_tomonth=".urlencode(request()->input('search_date_end_tomonth'))."&search_date_end_toyear=".urlencode(request()->input('search_date_end_toyear'));
}
