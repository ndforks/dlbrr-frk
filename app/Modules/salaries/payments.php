...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'bomlist'; // To manage different context of search
...
$mode       = request()->input('mode'); // mode view for result
...
$search_ref_salary = request()->input('search_ref_salary');
$search_user = request()->input('search_user');
$search_label = request()->input('search_label');
$search_date_start = dol_mktime(0, 0, 0, request()->integer('search_date_startmonth', 0), request()->integer('search_date_startday', 0), request()->integer('search_date_startyear', 0));
$search_date_end = dol_mktime(23, 59, 59, request()->integer('search_date_endmonth', 0), request()->integer('search_date_endday', 0), request()->integer('search_date_endyear', 0));
$search_dateep_start = dol_mktime(0, 0, 0, request()->integer('search_dateep_startmonth', 0), request()->integer('search_dateep_startday', 0), request()->integer('search_dateep_startyear', 0));
$search_dateep_end = dol_mktime(23, 59, 59, request()->integer('search_dateep_endmonth', 0), request()->integer('search_dateep_endday', 0), request()->integer('search_dateep_endyear', 0));
$search_amount = request()->input('search_amount');
$search_account = request()->integer('search_account', 0);
$search_fk_bank = request()->input('search_fk_bank');
$search_chq_number = request()->input('search_chq_number');
...
if ($search_date_start) {
	$param .= '&search_date_startday='.request()->integer('search_date_startday', 0).'&search_date_startmonth='.request()->integer('search_date_startmonth', 0).'&search_date_startyear='.request()->integer('search_date_startyear', 0);
}
if ($search_dateep_start) {
	$param .= '&search_dateep_startday='.request()->integer('search_dateep_startday', 0).'&search_dateep_startmonth='.request()->integer('search_dateep_startmonth', 0).'&search_dateep_startyear='.request()->integer('search_dateep_startyear', 0);
}
if ($search_date_end) {
	$param .= '&search_date_endday='.request()->integer('search_date_endday', 0).'&search_date_endmonth='.request()->integer('search_date_endmonth', 0).'&search_date_endyear='.request()->integer('search_date_endyear', 0);
}
if ($search_dateep_end) {
