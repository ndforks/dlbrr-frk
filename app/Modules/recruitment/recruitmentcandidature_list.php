...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : ((empty($id) && empty($ref)) ? 'recruitmentcandidaturelist' : 'recruitmentjobposition_candidature'); // To manage different context of search
