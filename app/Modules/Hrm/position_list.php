...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'positionlist'; // To manage different context of search
...
$vacant = request()->input('search_fk_uservacant') === 'on';
if ($vacant) {
	$sql .= ' AND t.fk_user = 0';
}
if ($search_all) {
