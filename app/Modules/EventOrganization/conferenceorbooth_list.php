...
if (!request()->input('confirmmassaction') && $massaction != 'presend'
...
if (empty($reshook)) {
	...
	if ($permissiontoadd && (($action == 'setstatus' && $confirm == "yes") || $massaction == 'setstatus')) {
		...
		foreach ($toselect as $key => $idselect) {
			...
			if ($result > 0) {
				$objecttmp->status = request()->integer('statusmassaction', 0);
...
if ($massaction == 'presetstatus') {
	...
	$formquestion[] = array('type' => 'other',
			...
			'value' => $form->selectarray('statusmassaction', $statuslist, request()->input('statusmassaction')));
