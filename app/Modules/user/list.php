...
$search_phonepro = request()->input('search_phonepro');
$search_phonemobile = request()->input('search_phonemobile');
...
$search_job = request()->input('search_job');
...
if (request()->has('formfilteraction')) {
	$searchCategoryUserOperator = request()->integer('search_category_user_operator', 0);
} elseif (getDolGlobalString('MAIN_SEARCH_CAT_OR_BY_DEFAULT')) {
	$searchCategoryUserOperator = getDolGlobalString('MAIN_SEARCH_CAT_OR_BY_DEFAULT');
}
$searchCategoryUserList = request()->input('search_category_user_list');
...
if ($contextpage == 'employeelist' && !request()->has('search_employee')) {
	$search_employee = 1;
}
...
if (request()->integer('nomassaction', 0) || in_array($massaction, array('presend', 'predelete', 'preaffecttag', 'presetsupervisor'))) {
	$arrayofmassactions = array();
}
