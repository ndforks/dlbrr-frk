...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'opensurveylist'; // To manage different context of search
...
$search_expired = request()->input('search_expired');
