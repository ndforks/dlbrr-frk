...
$show_files = request()->input('show_files'); // Show files area generated by bulk actions ?
...
$contextpage = request()->input('contextpage') ? request()->input('contextpage') : 'intracommreportlist';
if ((string) $type == '1') {
	$contextpage = 'DESlist';
	if ($search_type == '') {
		$search_type = '1';
