...
$year = request()->integer('reyear', 0) ? request()->integer('reyear', 0) : (request()->integer('year', 0) ? request()->integer('year', 0) : (request()->integer('addtimeyear', 0) ? request()->integer('addtimeyear', 0) : date("Y")));
$month = request()->integer('remonth', 0) ? request()->integer('remonth', 0) : (request()->integer('month', 0) ? request()->integer('month', 0) : (request()->integer('addtimemonth', 0) ? request()->integer('addtimemonth', 0) : date("m")));
$day = request()->integer('reday', 0) ? request()->integer('reday', 0) : (request()->integer('day', 0) ? request()->integer('day', 0) : (request()->integer('addtimeday', 0) ? request()->integer('addtimeday', 0) : date("d")));
...
$monthofday = request()->integer('addtimemonth', 0);
$dayofday = request()->integer('addtimeday', 0);
$yearofday = request()->integer('addtimeyear', 0);

//var_dump(request()->input('remonth'));
//var_dump(request()->input('button_search_x'));
//var_dump(request()->input('button_addtime'));
