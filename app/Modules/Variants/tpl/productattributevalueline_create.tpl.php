...
<tr class="pair nodrag nodrop nohoverpair<?php echo $nolinesbefore ? '' : ' liste_titre_create'; ?>">
	...
	<td class="nobottom linecolref">
		...
		<input type="text" name="line_ref" id="line_ref" class="flat" value="<?php echo(request()->has('line_ref') ? request()->input('line_ref') : ''); ?>" autofocus>
		<?php
	...
	<td class="nobottom linecolvalue"><?php $coldisplay++; ?>
		<input type="text" name="line_value" id="line_value" class="flat" value="<?php echo(request()->has('line_value') ? request()->input('line_value') : ''); ?>">
	</td>
