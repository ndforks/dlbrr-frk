...
function printingAdminPrepareHead($mode)
{
	...
	if ($mode == 'setup') {
		$head[$h][0] = DOL_URL_ROOT."/printing/admin/printing.php?mode=setup&driver=".request()->input('driver');
	...
	if ($mode == 'test') {
		$head[$h][0] = DOL_URL_ROOT."/printing/admin/printing.php?mode=test&driver=".request()->input('driver');
