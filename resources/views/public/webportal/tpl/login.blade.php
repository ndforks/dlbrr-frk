@php
/* Copyright (C) 2024MDW<mdeweerd@users.noreply.github.com>
...
<input type="text" class="login__input" name="login" placeholder="{{ dol_escape_htmltag($langs->trans('loginWebportalUserName')) }}">
</div>
<div class="login__field">
<i class="login__icon fas fa-lock"></i>
<input type="password" class="login__input" name="password" placeholder="{{ dol_escape_htmltag($langs->trans('Password')) }}">
</div>
<button class="button login__submit">
<span class="button__text">{{ dol_escape_htmltag($langs->trans('Connection')) }}</span>
