...
<!-- BEGIN BLADE TEMPLATE CONTACTCARD_CREATE.TPL.PHP DEFAULT -->
...
<form method="post" name="formsoc" action="{{ $_SERVER['PHP_SELF'] }}">
...
<td colspan="3">echo $this->control->tpl['select_zip'].'&nbsp !!}'.$this->control->tpl['select_town']; </td>
</tr>
...
<tr>
	...
	<td colspan="3"><input name="email" type="text" class="minwidth200" maxlength="80" value="@php $this->control->tpl['email'] @endphp"></td>
</tr>
